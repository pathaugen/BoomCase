...
// ========== ========== ========== ========== ========== ========== ========== ========== ========== ==========
func drawPageCase(ctx appengine.Context, output string, pageRequestedVariables1 string) (string) {
	...
	output = strings.Replace(output, "<CASEIMAGE>", "<img src=\"/serve/?blobKey=`+c.BlobKey+`\" />", -1)
	// ========== ========== ========== ========== ==========
